    ...
    protected static String makeParametersString(Input input) {
        try {
            ...
            parametersStringBuilder.append("Number of Chains: ").append(Integer.toString(numChains)).append("\n")
                    ...
                    .append("number of samples per surface tension measurement: ").append(Integer.toString(input.getJobParameters().getSimulationRunnerParameters().getNumSamples()))
                    .append("number of simulator iterations per sample: ").append(Integer.toString(input.getJobParameters().getSimulationRunnerParameters().getNumIterationsPerSample()))
